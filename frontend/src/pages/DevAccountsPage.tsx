...
import { Copy, Check, ArrowLeft, Eye, EyeOff, Shield, User, Briefcase, HardHat } from 'lucide-react';
import { useState } from 'react';

const accounts = [
  { role: 'SUPER_ADMIN', label: 'Super Admin', email: 'admin@bookflow.com', icon: Shield, color: '#efc493' },
  { role: 'COMPANY_ADMIN', label: 'Business Manager', email: 'manager@luxesalon.com', icon: Briefcase, color: '#86d6c8' },
  { role: 'CUSTOMER', label: 'Customer', email: 'customer@test.com', icon: User, color: '#c5a880' },
  { role: 'EMPLOYEE', label: 'Employee — Emma', email: 'emma@luxesalon.com', icon: HardHat, color: '#e8a0b4' },
  { role: 'EMPLOYEE', label: 'Employee — James', email: 'james@luxesalon.com', icon: HardHat, color: '#7eb8da' },
];
      ...
      <div className="w-full max-w-2xl mx-auto space-y-6">
        ...
        <div className="space-y-3">
          ...
          <p className="text-sm text-[#aaa9a5] leading-relaxed">
            Pre-seeded accounts for local development. All accounts share the same password.
          </p>
        </div>
